...
import top.xiajibagao.powerfulannotation.annotation.AliasFor;
import top.xiajibagao.powerfulannotation.annotation.ForceAliasFor;
import top.xiajibagao.powerfulannotation.annotation.Link;
import top.xiajibagao.powerfulannotation.annotation.MirrorFor;
...
public class GenericSynthesizedAggregateAnnotationTest {
	...
	public void baseSynthesisAnnotationWorkTest() {
		...
		Assert.assertEquals(2, syntheticMetaAnnotation.getAnnotationPostProcessors().size());
	}
	...
	@interface ChildAnnotation {
		@ForceAliasFor(attribute = "childValue")
