...
public class SimpleRepeatableMappingRegistry implements RepeatableMappingRegistry {
	 ...
	 */
	@Override
	public synchronized void registerMappingParser(RepeatableMappingParser mappingParser) {
	 ...
	 */
	@Override
	public synchronized void register(Class<? extends Annotation> annotationType) {
